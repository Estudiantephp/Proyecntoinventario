							...
							<div class="full-width panel-content">
								<form action = "categories.php" method="POST">
									...
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-z0-9áéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" name="NameCategory" value="<?php echo $nombre; ?>" >
										<label class="mdl-textfield__label" for="NameCategory">Nombre</label>
										<span class="mdl-textfield__error">Invalid name</span>
									</div>
		
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text"  name="descriptinCategory"  value="<?php echo $descripcion; ?>">
                                    ...
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text"  name="fecha"value="<?php echo $fecha; ?> ">
										<label class="mdl-textfield__label" for="descriptionCategory">Fecha</label>
										<span class="mdl-textfield__error">Invalid descripción</span>
									</div>
