		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					En esta sección podras ver los datos de una categoria.
				</p>
			</div>
		</section>
							...
							<div class="full-width panel-content">
								<form action = "categories.php" method="POST">
									...
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										...
										<label class="mdl-textfield__label" for="descriptionCategory">Direción</label>
										<span class="mdl-textfield__error">Invalid descripción</span>
									</div>

                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text"  name="tel" value="<?php echo $telefono; ?> ">
										<label class="mdl-textfield__label" for="descriptionCategory">Telefono</label>
										<span class="mdl-textfield__error">Invalid descripción</span>
									</div>

<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text"  name="correo"  value="<?php echo $correo; ?>">
										<label class="mdl-textfield__label" for="descriptionCategory">Correo</label>
										<span class="mdl-textfield__error">Invalid descripción</span>
									</div>

									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text"  name="web"  value="<?php echo $web; ?>">
										<label class="mdl-textfield__label" for="descriptionCategory">Pagina web</label>
										<span class="mdl-textfield__error">Invalid descripción</span>
									</div>
								</form>
							</div>
